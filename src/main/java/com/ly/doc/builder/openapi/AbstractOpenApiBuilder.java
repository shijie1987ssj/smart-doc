...
public abstract class AbstractOpenApiBuilder {
	 ...
	 */
	abstract public Map<String, Object> buildComponentsSchema(ApiConfig config, ApiSchema<ApiDoc> apiSchema);
	...
	public Map<String, Object> buildPaths(ApiConfig apiConfig, ApiSchema<ApiDoc> apiSchema,
			LinkedHashSet<OpenApiTag> tags) {
